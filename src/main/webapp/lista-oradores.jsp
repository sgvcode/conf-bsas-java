...
<body>
        ...
        <section class="bloque-lista">
            ...
            <div class="bloque-datos">
                ...
                <div class="gap-2 d-flex banda-editar justify-content-end pe-2">
                    ...
                    <!-- Agrega la función de confirmación para el borrado -->
    ...
    <script>
        // Función para desplazarse automáticamente a la última posición de la lista
        ...
        // Desplazarse automáticamente a la última posición después de cargar la página
