...
<main class="listado">
    ...
    <section class="popup__login" id="login">
        <form class="form-group" action="los-oradores">
    ...
    <div class="d-flex justify-content-end w-100 mt-5 btn-pos">
        <a href="${pageContext.request.contextPath}/los-oradores?form=agregar"
           class="btn-orador-add">Agregar orador</a>
    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="botones-cards d-flex justify-content-end">
                        <a href="${pageContext.request.contextPath}/los-oradores?action=editar&id=<%= orador.getId() %>"
                           class="btn-orador-edit btn-card">
